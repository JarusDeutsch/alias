...
function renderLobbyCard() {
  ...
  return `
    ...
    <div class="mt-5 grid gap-3">
      ...
      <div class="alias-divider pt-3 mt-4">
      ...
      <div class="alias-divider pt-3 mt-3">
...
function renderHelpCard() {
  return `
    ...
    <div class="alias-divider pt-4 mt-4">
    <ul class="grid gap-2 text-base text-slate-300">
...
function renderGlobalTimer(view: WsView) {
  ...
  wrapClass += 'mt-6 pb-6 alias-divider'
  return `
...
function renderGameLayout(view: WsView) {
  ...
  return `
    ...
    ${top}
    <div class="mt-6 pt-6 alias-divider grid gap-6 lg:grid-cols-[1fr_minmax(0,960px)_1fr]">
...
function renderTopBar(view: WsView) {
  ...
  return `
    <div class="mt-6 pt-6 alias-divider">
...
function renderMyTeamPanel(view: WsView) {
  if (!view.me.team_id) {
    return `
      ...
      <div class="alias-divider pt-4 mt-4">${renderTeamChooser(view)}</div>
  ...
  return `
    ...
    <div class="alias-divider pt-3 mt-3 grid gap-2">
    ...
    <div class="alias-divider pt-4 mt-4 grid gap-2">
...
function renderCenterPanel(view: WsView) {
  ...
  if (isCluegiver) {
    ...
    return `
      ...
      <div class="alias-divider mt-6 pt-6">
      <div class="rounded-md bg-gradient-to-b from-white/12 to-white/5 p-7 ring-1 ring-white/10">
      ...
      <div class="alias-divider mt-5 pt-5 alias-outcome-buttons rounded-md p-3 ring-1 ring-white/10 ${timeExpired ? 'alias-outcome-buttons-expired' : ''}">
      ...
      <div class="alias-divider mt-4 pt-4 rounded-md bg-white/5 px-3 py-2 text-base text-slate-300 ring-1 ring-white/10">
  ...
  return `
    ...
    <div class="alias-divider mt-6 pt-6 rounded-md bg-white/5 p-7 ring-1 ring-white/10">
...
function renderRightPanel(view: WsView) {
  ...
  const settings =
    store.settingsOpen
      ? `
      <div class="alias-divider mt-4 pt-4 grid gap-3">
        ${wordPackSelect}
  ...
  const controls =
    view.me.role === 'cluegiver' && view.me.team_id
      ? `
      <div class="alias-divider mt-4 pt-4 grid gap-3 sm:grid-cols-2">
  ...
  const history = team
    ? `
      <div class="alias-divider mt-6 pt-6 rounded-md bg-white/5 p-5 ring-1 ring-white/10">
        <div class="text-base text-slate-300">История слов (текущий раунд)</div>
        <div class="mt-3 max-h-[510px] overflow-y-auto pr-1">
          ${renderRoundHistory(team, true, !team.round_active)}
        </div>
